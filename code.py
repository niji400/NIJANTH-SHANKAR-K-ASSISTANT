...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('nijanthshk685@gmail.com', 'sumasuma')
...
if _name_ == "_main_":
    ...
    #logic for executing tasks based on query
        ...
        if 'open youtube' in query:
            ...
            speak("I have been created by NIJANTH SHANKAR K.")
            ...
            speak("Thanks to NIJANTH SHANKAR K. further It's a secret")

        elif 'is love' in query:
            speak("It is 7th sense that destroy all other senses")

        elif "who are you" in query:
            speak("I am your virtual assistant created by PANDA")

        elif 'reason for creating you' in query:
            speak("I was created as a Minor project by Mister NIJANTH SHANKAR K ")
        ...
        elif "will you be my friend" in query or "will you be my boyfriend" in query:
        ...
        speak(" please tell me sir, do you have any other work")